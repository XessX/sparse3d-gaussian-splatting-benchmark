# Scientific Reports Final Checklist
...
| Supplementary figures listed | 26 | pass |
| Supplementary tables listed | 17 | pass |
| References | 17 | pass |
...
| ORCID | 0009-0005-3498-5826 | pass |

## Submission Files

| file | status |
| --- | --- |
| `manuscript/submission/scientific_reports_manuscript_final.md` | present |
| `manuscript/submission/scientific_reports_manuscript_final.docx` | present |
| `manuscript/submission/scientific_reports_manuscript_final.pdf` | present |
| `manuscript/submission/supplementary_information_final.md` | present |
| `manuscript/submission/supplementary_information_final.pdf` | present |
| `manuscript/submission/scientific_reports_cover_letter_final.md` | present |
| `manuscript/submission/apc_waiver_request_final.md` | present |
| `manuscript/submission/unresolved_manual_items.md` | present |
| `manuscript/submission/export_instructions.md` | present |
| `manuscript/draft/submission_readiness_audit.md` | present |
| `manuscript/draft/final_submission_audit.md` | present |
| `manuscript/draft/journal_polish_audit.md` | present |

## Data and Code Availability

| item | status |
| --- | --- |
| Public dataset sources noted | yes |
| Raw images included in lightweight package | no |
| Dataset redistribution status | manual license verification required |
| Result CSVs included | yes |
| Figures and tables included | yes |
| External setup/environment files included | yes |
| Public data repository link | https://doi.org/10.5281/zenodo.20478630 |
...
| GitHub release URL | https://github.com/XessX/sparse3d-gaussian-splatting-benchmark/releases/tag/v0.1.6 |
| Zenodo record URL | https://zenodo.org/records/20478630 |
| Zenodo DOI/link | https://doi.org/10.5281/zenodo.20478630 |
...
- Final journal portal format check.
- Manual DOCX visual QA in Word or LibreOffice; automated rendering was unavailable because LibreOffice/`soffice` is not installed.
